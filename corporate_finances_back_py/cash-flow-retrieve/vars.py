...
cash_flow_all_items = ['Utilidad neta', 
                        ...
                        'Otros ingresos y egresos no operativos CF',
                        'EBIT', 
...
pyg_items = ['Utilidad antes de impuestos',
            'Impuestos de renta',
            'Intereses/gasto financiero',
            'Deterioro',
            'Otros ingresos y egresos operativos',
...
capex_items = ['Depreciación del Periodo', 'Amortización del Periodo', 'CAPEX', 'Depreciación Capex']

patrimony_items = ['Aportes de capital social u otros', 'Dividentos en efectivo']

other_projections = ['Otros movimientos que no son salida ni entrada de efectivo operativos', 'Otros movimientos netos de activos operativos que afecta el FCLA', 'Otros movimientos netos de activos operativos que afecta el FCLO']

wk_items = ['Capital de trabajo']

debt_items = ['Variación de deuda'] #Este no sé si se pueda usar así o es un metodo con calculos propios

"""
cash_flow_totals = {'Flujo de caja bruto':{'dependencies': ['UODI (NOPAT)','Depreciación','Deterioro','Amortización', 'Depreciación Capex','Otros movimientos que no son salida ni entrada de efectivo operativos'],
                                            'is_sum': [1,1,1,1,1,-1]},
                    ...
                    'Flujo de caja del accionista':{'dependencies':['Flujo de caja Libre Operacional', 'Intereses/gasto financiero FC', 'Impuestos no operacionales', 'Variación de deuda', 'Otros movimientos netos de activos operativos que afecta el FCLA', 'Otros ingresos y egresos no operativos'], 
                                            'is_sum':[1,-1,-1,1,-1,1]},
