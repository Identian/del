...
from decorators import handler_wrapper, debugger_wrapper, try_pass_wrapper
...
@try_pass_wrapper('Error llamando a Core Engine')
def call_dynamic_engine(id_assessment):
